...
void RKR::putbuf(char *buf, int j) {
	...
	case 8:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[0][0],
				&lv[0][1], &lv[0][2], &lv[0][3], &lv[0][4], &lv[0][5],
				&lv[0][6], &lv[0][7], &lv[0][8], &lv[0][9], &lv[0][10],
				&lv[0][11], &Reverb_B);
		break;
	...
	case 4:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[1][0], &lv[1][1],
				&lv[1][2], &lv[1][3], &lv[1][4], &lv[1][5], &lv[1][6],
				&lv[1][7], &lv[1][8], &Echo_B);
		break;

	case 5:
		//Chorus
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[2][0],
				&lv[2][1], &lv[2][2], &lv[2][3], &lv[2][4], &lv[2][5],
				&lv[2][6], &lv[2][7], &lv[2][8], &lv[2][9], &lv[2][10],
				&lv[2][11], &Chorus_B);
		break;
	...
	case 7:
		//Flanger
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[3][0],
				&lv[3][1], &lv[3][2], &lv[3][3], &lv[3][4], &lv[3][5],
				&lv[3][6], &lv[3][7], &lv[3][8], &lv[3][9], &lv[3][10],
				&lv[3][11], &Flanger_B);
		break;
	...
	case 6:
		//Phaser
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[4][0],
				&lv[4][1], &lv[4][2], &lv[4][3], &lv[4][4], &lv[4][5],
				&lv[4][6], &lv[4][7], &lv[4][8], &lv[4][9], &lv[4][10],
				&lv[4][11], &Phaser_B);
		break;
	...
	case 3:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[5][0],
				&lv[5][1], &lv[5][2], &lv[5][3], &lv[5][4], &lv[5][5],
				&lv[5][6], &lv[5][7], &lv[5][8], &lv[5][9], &lv[5][10],
				&lv[5][11], &lv[5][12], &Overdrive_B);
		break;

	case 2:
		//Distorsion
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[6][0],
				&lv[6][1], &lv[6][2], &lv[6][3], &lv[6][4], &lv[6][5],
				&lv[6][6], &lv[6][7], &lv[6][8], &lv[6][9], &lv[6][10],
				&lv[6][11], &lv[6][12], &Distorsion_B);
		break;

	case 0:
		//EQ1
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[7][0],
				&lv[7][1], &lv[7][2], &lv[7][3], &lv[7][4], &lv[7][5],
				&lv[7][6], &lv[7][7], &lv[7][8], &lv[7][9], &lv[7][10],
				&lv[7][11], &EQ1_B);
		break;
	...
	case 9:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[8][0], &lv[8][1],
				&lv[8][2], &lv[8][3], &lv[8][4], &lv[8][5], &lv[8][6],
				&lv[8][7], &lv[8][8], &lv[8][9], &EQ2_B);
		break;

	case 1:
		//Compressor
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[9][0], &lv[9][1],
				&lv[9][2], &lv[9][3], &lv[9][4], &lv[9][5], &lv[9][6],
				&lv[9][7], &lv[9][8], &Compressor_B);
		break;

	case 10:
		//WhaWha
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[11][0],
				&lv[11][1], &lv[11][2], &lv[11][3], &lv[11][4], &lv[11][5],
				&lv[11][6], &lv[11][7], &lv[11][8], &lv[11][9], &lv[11][10],
				&WhaWha_B);
		break;
	...
	case 11:
		//Alienwah
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[12][0],
				&lv[12][1], &lv[12][2], &lv[12][3], &lv[12][4], &lv[12][5],
				&lv[12][6], &lv[12][7], &lv[12][8], &lv[12][9], &lv[12][10],
				&Alienwah_B);
		break;
	...
	case 13:
		//Pan
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[14][0], &lv[14][1],
				&lv[14][2], &lv[14][3], &lv[14][4], &lv[14][5], &lv[14][6],
				&lv[14][7], &lv[14][8], &Pan_B);
		break;

	case 14:
		//Harmonizer
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[15][0],
				&lv[15][1], &lv[15][2], &lv[15][3], &lv[15][4], &lv[15][5],
				&lv[15][6], &lv[15][7], &lv[15][8], &lv[15][9], &lv[15][10],
				&Harmonizer_B);
		break;
	...
	case 15:
		//Musical Delay
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[16][0],
				&lv[16][1], &lv[16][2], &lv[16][3], &lv[16][4], &lv[16][5],
				&lv[16][6], &lv[16][7], &lv[16][8], &lv[16][9], &lv[16][10],
				&lv[16][11], &lv[16][12], &MusDelay_B);
		break;

	case 16:
		//NoiseGate
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[17][0], &lv[17][1],
				&lv[17][2], &lv[17][3], &lv[17][4], &lv[17][5], &lv[17][6],
				&Gate_B);
	...
	case 17:
		//NewDist
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[18][0],
				&lv[18][1], &lv[18][2], &lv[18][3], &lv[18][4], &lv[18][5],
				&lv[18][6], &lv[18][7], &lv[18][8], &lv[18][9], &lv[18][10],
				&lv[18][11], &NewDist_B);
		break;
	...
	case 18:
		//Analog Phaser
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[19][0],
				&lv[19][1], &lv[19][2], &lv[19][3], &lv[19][4], &lv[19][5],
				&lv[19][6], &lv[19][7], &lv[19][8], &lv[19][9], &lv[19][10],
				&lv[19][11], &APhaser_B);
		break;
	...
	case 19:
		//Valve
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[20][0],
				&lv[20][1], &lv[20][2], &lv[20][3], &lv[20][4], &lv[20][5],
				&lv[20][6], &lv[20][7], &lv[20][8], &lv[20][9], &lv[20][10],
				&lv[20][11], &lv[20][12], &Valve_B);
		break;
	...
	case 21:
		//Ring
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[22][0],
				&lv[22][1], &lv[22][2], &lv[22][3], &lv[22][4], &lv[22][5],
				&lv[22][6], &lv[22][7], &lv[22][8], &lv[22][9], &lv[22][10],
				&lv[22][11], &lv[22][12], &Ring_B);
		break;

	case 22:
		//Exciter
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[23][0],
				&lv[23][1], &lv[23][2], &lv[23][3], &lv[23][4], &lv[23][5],
				&lv[23][6], &lv[23][7], &lv[23][8], &lv[23][9], &lv[23][10],
				&lv[23][11], &lv[23][12], &Exciter_B);
		break;
	...
	case 24:
		//Arpie
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[25][0],
				&lv[25][1], &lv[25][2], &lv[25][3], &lv[25][4], &lv[25][5],
				&lv[25][6], &lv[25][7], &lv[25][8], &lv[25][9], &lv[25][10],
				&Arpie_B);
		break;
	...
	case 25:
		//Expander
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[26][0], &lv[26][1],
				&lv[26][2], &lv[26][3], &lv[26][4], &lv[26][5], &lv[26][6],
				&Expander_B);
	...
	case 26:
		//Shuffle
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[27][0],
				&lv[27][1], &lv[27][2], &lv[27][3], &lv[27][4], &lv[27][5],
				&lv[27][6], &lv[27][7], &lv[27][8], &lv[27][9], &lv[27][10],
				&Shuffle_B);
		break;
	...
	case 28:
		//MBVvol
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[29][0],
				&lv[29][1], &lv[29][2], &lv[29][3], &lv[29][4], &lv[29][5],
				&lv[29][6], &lv[29][7], &lv[29][8], &lv[29][9], &lv[29][10],
				&MBVvol_B);
		break;
	...
	case 29:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n", &lv[30][0],
				&lv[30][1], &lv[30][2], &lv[30][3], &lv[30][4], &lv[30][5],
				&lv[30][6], &lv[30][7], &lv[30][8], &lv[30][9], &lv[30][10],
				&Convol_B, cfilename);
		efx_Convol->setFileName(cfilename);
		break;
	...
	case 32:
		//Echoverse
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[33][0],
				&lv[33][1], &lv[33][2], &lv[33][3], &lv[33][4], &lv[33][5],
				&lv[33][6], &lv[33][7], &lv[33][8], &lv[33][9], &RBEcho_B);
		break;

	case 33:
		//CoilCrafter
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[34][0], &lv[34][1],
				&lv[34][2], &lv[34][3], &lv[34][4], &lv[34][5], &lv[34][6],
				&lv[34][7], &lv[34][8], &CoilCrafter_B);
		break;

	case 34:
		//CoilCrafter
		sscanf(buf, "%d,%d,%d,%d,%d,%d\n", &lv[35][0], &lv[35][1], &lv[35][2],
				&lv[35][3], &lv[35][4], &ShelfBoost_B);
		break;

	case 35:
		//Vocoder
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[36][0], &lv[36][1],
				&lv[36][2], &lv[36][3], &lv[36][4], &lv[36][5], &lv[36][6],
				&Vocoder_B);
		break;
	...
	case 37:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				...
				&lv[38][10], &lv[38][11], &lv[38][12], &lv[38][13], &lv[38][14],
				&Looper_B);
		break;
	...
	case 38:
		//Shifter
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[39][0],
				&lv[39][1], &lv[39][2], &lv[39][3], &lv[39][4], &lv[39][5],
				&lv[39][6], &lv[39][7], &lv[39][8], &lv[39][9], &Shifter_B);
		break;

	case 39:
		//StompBox
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d\n", &lv[40][0], &lv[40][1],
				&lv[40][2], &lv[40][3], &lv[40][4], &lv[40][5], &StompBox_B);
		break;
	...
	case 40:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n",
				...
				&lv[41][10], &lv[41][11], &lv[41][12], &lv[41][13], &lv[41][14],
				&lv[41][15], &Reverbtron_B, cfilename);
		efx_Reverbtron->setFileName(cfilename);
		break;
	...
	case 41:
		...
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n",
				...
				&lv[42][10], &lv[42][11], &lv[42][12], &lv[42][13], &lv[42][14],
				&lv[42][15], &Echotron_B, cfilename);
		efx_Echotron->setFileName(cfilename);
		break;

	case 42:
		//StereoHarm
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[43][0],
				&lv[43][1], &lv[43][2], &lv[43][3], &lv[43][4], &lv[43][5],
				&lv[43][6], &lv[43][7], &lv[43][8], &lv[43][9], &lv[43][10],
				&lv[43][11], &StereoHarm_B);
		break;

	case 43:
		//CompBand
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[44][0],
				&lv[44][1], &lv[44][2], &lv[44][3], &lv[44][4], &lv[44][5],
				&lv[44][6], &lv[44][7], &lv[44][8], &lv[44][9], &lv[44][10],
				&lv[44][11], &lv[44][12], &CompBand_B);
		break;

	case 44:
		//Opticaltrem
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d\n", &lv[45][0], &lv[45][1],
				&lv[45][2], &lv[45][3], &lv[45][4], &lv[45][5], &Opticaltrem_B);
		break;

	case 45:
		//Vibe
		sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[46][0],
				&lv[46][1], &lv[46][2], &lv[46][3], &lv[46][4], &lv[46][5],
				&lv[46][6], &lv[46][7], &lv[46][8], &lv[46][9], &Vibe_B);
		break;
...
void RKR::getbuf(char *buf, int j) {
	...
	case 8:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				efx_Rev->getpar(0), efx_Rev->getpar(1), efx_Rev->getpar(2),
				efx_Rev->getpar(3), efx_Rev->getpar(4), efx_Rev->getpar(5),
				efx_Rev->getpar(6), efx_Rev->getpar(7), efx_Rev->getpar(8),
				efx_Rev->getpar(9), efx_Rev->getpar(10), efx_Rev->getpar(11),
				Reverb_Bypass);
		break;
	...
	case 4:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Echo->getpar(0),
				efx_Echo->getpar(1), efx_Echo->getpar(2), efx_Echo->getpar(3),
				efx_Echo->getpar(4), efx_Echo->getpar(5), efx_Echo->getpar(6),
				efx_Echo->getpar(7), efx_Echo->getpar(8), Echo_Bypass);
		break;
	...
	case 5:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				...
				efx_Chorus->getpar(10), efx_Chorus->getpar(11), Chorus_Bypass);
		break;
	...
	case 6:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				...
				efx_Phaser->getpar(10), efx_Phaser->getpar(11), Phaser_Bypass);
		break;
	...
	case 9:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", efx_EQ2->getpar(11),
				efx_EQ2->getpar(12), efx_EQ2->getpar(13),
				efx_EQ2->getpar(5 + 11), efx_EQ2->getpar(5 + 12),
				efx_EQ2->getpar(5 + 13), efx_EQ2->getpar(10 + 11),
				efx_EQ2->getpar(10 + 12), efx_EQ2->getpar(10 + 13),
				efx_EQ2->getpar(0), EQ2_Bypass);
		break;
	...
	case 10:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				...
				efx_WhaWha->getPpreset(), WhaWha_Bypass);
		break;
	...
	case 12:
		//Cabinet
		sprintf(buf, "%d,%d,%d\n", Cabinet_Preset, efx_Cabinet->getpar(0),
				Cabinet_Bypass);
		break;
	...
	case 13:
		//Pan
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Pan->getpar(0),
				efx_Pan->getpar(1), efx_Pan->getpar(2), efx_Pan->getpar(3),
				efx_Pan->getpar(4), efx_Pan->getpar(5), efx_Pan->getpar(6),
				efx_Pan->getpar(7), efx_Pan->getpar(8), Pan_Bypass);
		break;

	case 14:
		//Harmonizer
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				efx_Har->getpar(0), efx_Har->getpar(1), efx_Har->getpar(2),
				efx_Har->getpar(3), efx_Har->getpar(4), efx_Har->getpar(5),
				efx_Har->getpar(6), efx_Har->getpar(7), efx_Har->getpar(8),
				efx_Har->getpar(9), efx_Har->getpar(10), Harmonizer_Bypass);
		break;
	...
	case 16:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Gate->getpar(1),
				efx_Gate->getpar(2), efx_Gate->getpar(3), efx_Gate->getpar(4),
				efx_Gate->getpar(5), efx_Gate->getpar(6), efx_Gate->getpar(7),
				Gate_Bypass);
		break;
	...
	case 21:
		//Ring
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
				efx_Ring->getpar(0), efx_Ring->getpar(1), efx_Ring->getpar(2),
				efx_Ring->getpar(3), efx_Ring->getpar(4), efx_Ring->getpar(5),
				efx_Ring->getpar(6), efx_Ring->getpar(7), efx_Ring->getpar(8),
				efx_Ring->getpar(9), efx_Ring->getpar(10), efx_Ring->getpar(11),
	...
	case 25:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Expander->getpar(1),
				efx_Expander->getpar(2), efx_Expander->getpar(3),
				efx_Expander->getpar(4), efx_Expander->getpar(5),
				efx_Expander->getpar(6), efx_Expander->getpar(7),
				Expander_Bypass);
		break;
	...
	case 29:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n",
				...
				efx_Convol->getpar(10), Convol_Bypass, efx_Convol->getFileName());
		break;
	...
	case 34:
		//ShelfBoost
		sprintf(buf, "%d,%d,%d,%d,%d,%d\n", efx_ShelfBoost->getpar(0),
				efx_ShelfBoost->getpar(1), efx_ShelfBoost->getpar(2),
				efx_ShelfBoost->getpar(3), efx_ShelfBoost->getpar(4),
				ShelfBoost_Bypass);
		break;

	case 35:
		//Vocoder
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Vocoder->getpar(0),
				efx_Vocoder->getpar(1), efx_Vocoder->getpar(2),
				efx_Vocoder->getpar(3), efx_Vocoder->getpar(4),
				efx_Vocoder->getpar(5), efx_Vocoder->getpar(6), Vocoder_Bypass);
		break;

	case 36:
		//Sustainer
		sprintf(buf, "%d,%d,%d\n", efx_Sustainer->getpar(0),
				efx_Sustainer->getpar(1), Sustainer_Bypass);
		break;
	...
	case 39:
		//StompBox
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d\n", efx_StompBox->getpar(0),
				efx_StompBox->getpar(1), efx_StompBox->getpar(2),
				efx_StompBox->getpar(3), efx_StompBox->getpar(4),
				efx_StompBox->getpar(5), StompBox_Bypass);
		break;
	...
	case 40:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n",
				...
				Reverbtron_Bypass, efx_Reverbtron->getFileName());
		break;
	...
	case 41:
		...
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%s\n",
				...
				Echotron_Bypass, efx_Echotron->getFileName());
		break;
	case 42:
		//StereoHarm
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
	...
	case 44:
		//Opticaltrem
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d\n", efx_Opticaltrem->getpar(0),
				efx_Opticaltrem->getpar(1), efx_Opticaltrem->getpar(2),
				efx_Opticaltrem->getpar(3), efx_Opticaltrem->getpar(4),
				efx_Opticaltrem->getpar(5), Opticaltrem_Bypass);
		break;

	case 45:
		//Vibe
		sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", efx_Vibe->getpar(0),
				efx_Vibe->getpar(1), efx_Vibe->getpar(2), efx_Vibe->getpar(3),
				efx_Vibe->getpar(4), efx_Vibe->getpar(5), efx_Vibe->getpar(6),
				efx_Vibe->getpar(7), efx_Vibe->getpar(8), efx_Vibe->getpar(9),
				Vibe_Bypass);
		break;
...
void RKR::savefile(char *filename) {
	...
	//General
	memset(buf, 0, sizeof(buf));
	sprintf(buf, "%f,%f,%f,%d\n", Input_Gain, Master_Volume, Fraction_Bypass,
			Bypass_B);
	fputs(buf, fn);
	...
	// Order
	memset(buf, 0, sizeof(buf));
	sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", efx_order[0], efx_order[1],
			efx_order[2], efx_order[3], efx_order[4], efx_order[5],
			efx_order[6], efx_order[7], efx_order[8], efx_order[9]);
...
void RKR::loadfile(char *filename) {
	...
	fgets(buf, sizeof buf, fn);
	sscanf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", &lv[10][0], &lv[10][1],
			&lv[10][2], &lv[10][3], &lv[10][4], &lv[10][5], &lv[10][6],
			&lv[10][7], &lv[10][8], &lv[10][9]);
...
void RKR::Actualizar_Audio() {
	...
	for (j = 0; j < 10; j++) {
		...
		case 41: //Echotron
			...
			efx_Echotron->setPchange(1);
			for (i = 0; i <= 15; i++)
				efx_Echotron->changepar(i, lv[42][i]);
			efx_Echotron->setPchange(0);
...
int RKR::loadbank(char *filename) {
	...
	case 1:
		Message(1, meslabel,
				"Can not load this Bank file because is from a old rakarrack version,\n please use 'Convert Old Bank' menu entry in the Bank window.");
		return (0);
		break;
	case 2:
	...
	case 3:
		Message(1, meslabel,
				"Can not load this Bank file because is from a old rakarrack git version,\n please use rakgit2new utility to convert.");
		return (0);
		break;
...
int RKR::savebank(char *filename) {
...
//Vibe
	...
	efx_Convol->setFileName(0);
	efx_Reverbtron->setFileName(0);
	efx_Echotron->setFileName(0);
...
void RKR::Bank_to_Preset(int i) {
	...
	efx_Convol->setFileName(Bank[i].ConvoFiname);
	efx_Reverbtron->setFileName(Bank[i].RevFiname);
	efx_Echotron->setFileName(Bank[i].EchoFiname);
	...
	if ((Tap_Updated) && (Tap_Bypass) && (Tap_TempoSet > 0)
			&& (Tap_TempoSet < 601))
		Update_tempo();
...
void RKR::Preset_to_Bank(int i) {
	...
	strcpy(Bank[i].ConvoFiname, efx_Convol->getFileName());
	strcpy(Bank[i].RevFiname, efx_Reverbtron->getFileName());
	strcpy(Bank[i].EchoFiname, efx_Echotron->getFileName());
	...
	Bank[i].lv[11][10] = efx_WhaWha->getPpreset();
...
void RKR::convert_IO() {
	...
	for (i = 0; i < 62; i++) {
		...
		if (Bank[i].Input_Gain == 0.0)
			Bank[i].Input_Gain = 0.5f;

		sscanf(Bank[i].cMaster_Volume, "%f", &Bank[i].Master_Volume);
		if (Bank[i].Master_Volume == 0.0)
			Bank[i].Master_Volume = 0.5f;

		sscanf(Bank[i].cBalance, "%f", &Bank[i].Balance);
		if (Bank[i].Balance == 0.0)
			Bank[i].Balance = 1.0f;
...
void RKR::saveskin(char *filename) {
	...
	memset(buf, 0, sizeof(buf));
	sprintf(buf, "%d,%d,%d,%d\n", sback_color, sfore_color, slabel_color,
			sleds_color);
	fputs(buf, fn);
...
void RKR::loadskin(char *filename) {
	unsigned int i;
	char buf[256];
	FILE *fn;
...
void RKR::dump_preset_names(void) {
	int i;

	for (i = 0; i < 62; i++) {
		fprintf(stderr, "RKR_BANK_NAME:%d:%s\n", i, Bank[i].Preset_Name);
	}

}

int RKR::CheckOldBank(char *filename) {
...
void RKR::ConvertOldFile(char * filename) {
...
void RKR::ConvertReverbFile(char * filename) {
	char buff[255];
	memset(buff, 0, sizeof(buff));
...
void RKR::SaveIntPreset(int num, char *name) {
	FILE *fn;
	char tempfile[256];
	char buf[256];
	char sbuf[256];
...
void RKR::DelIntPreset(int num, char *name) {
	FILE *fn;
	FILE *fs;
	char *rname;
	int eff = 0;
...
void RKR::MergeIntPreset(char *filename) {
...
void RKR::savemiditable(char *filename) {
...
void RKR::loadmiditable(char *filename) {
	int i;
	char buf[256];
	FILE *fn;
