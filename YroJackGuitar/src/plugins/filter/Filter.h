...
#include <plugins/filter/YroDefaultFilter.h>
#include <plugins/filter/FilterParams.h>
#include <plugins/filter/FormantFilter.h>
#include <plugins/filter/SVFilter.h>
#include <plugins/filter/AnalogFilter.h>

namespace std {

class Filter: public YroDefaultFilter {
public:
