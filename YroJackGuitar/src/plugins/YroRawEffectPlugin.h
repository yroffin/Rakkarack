/*
 ...
 YroRawEffectPlugin.h
 */

#ifndef YRORAWEFFECTPLUGIN_H_
#define YRORAWEFFECTPLUGIN_H_
...
class YroRawEffectPlugin: public std::YroObject {
public:
	/**
	...
	YroRawEffectPlugin(const char *_name);
	YroRawEffectPlugin(const char *_name, const char *_presets);
	virtual ~YroRawEffectPlugin();
	virtual void cleanup () {
		getLogger()->error("Not implemented");
	}
	/**
	 * class definition magic number
	 */
	enum {
		_Default,
		_Distortion,
	...
	enum {
		_applyEffectOnInput,
		_applyEffectOnInAndCopyToOut
	} behaviour;
	/**
	 * processing
	 */
	virtual int getBehaviour();
	void toggle();
