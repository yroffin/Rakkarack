...
Echo::Echo() : YroEffectPlugin("Echo")
{
 ...
 */
void
Echo::render(jack_nframes_t nframes,float * smpsl, float * smpsr)
{
  int i;
...
if ((unsigned int) delay > (iSAMPLE_RATE * MAX_DELAY)) delay = iSAMPLE_RATE*MAX_DELAY;
initdelays();
}
