...
ShelfBoost::ShelfBoost() : YroEffectPlugin("ShelfBoost")
{
 ...
 */
void
ShelfBoost::render(jack_nframes_t nframes,float * smpsl, float * smpsr)
{
int i;


RB1l->filterout(iPERIOD,fPERIOD,smpsl);
if(Pstereo) RB1r->filterout(iPERIOD,fPERIOD,smpsr);
...
if(!Pstereo) memcpy(smpsr,smpsl,sizeof(float)*iPERIOD);
