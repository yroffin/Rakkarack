 ...
 * toXml member
*/
const char *Looper::toXml() {
        char _buffer[256];
        char _formatd[] = {"<attribute name=\"%s\" value=\"%d\" />"};
        char _formatf[] = {"<attribute name=\"%s\" value=\"%9.40f\" />"};
        strcpy(_toXml,"<attributes>");
        sprintf(_buffer,_formatd,"barlen",barlen);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"looper_ts",looper_ts);
        strcat(_toXml,_buffer);
        ...
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"rvkl2",rvkl2);
        strcat(_toXml,_buffer);
        ...
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"first_time1",first_time1);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"looper_bar",looper_bar);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"looper_qua",looper_qua);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pautoplay",Pautoplay);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pbar",Pbar);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pclear",Pclear);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pfade1",Pfade1);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pfade2",Pfade2);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Plink",Plink);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pmetro",Pmetro);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pms",Pms);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pplay",Pplay);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Ppreset",Ppreset);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Prec1",Prec1);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Prec2",Prec2);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Precord",Precord);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Preverse",Preverse);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"progstate[6]",progstate[6]);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pstop",Pstop);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"PT1",PT1);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"PT2",PT2);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Ptempo",Ptempo);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatd,"Pvolume",Pvolume);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"mvol",mvol);
        strcat(_toXml,_buffer);
        ...
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"track1gain",track1gain);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"track2gain",track2gain);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"fade1",fade1);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"fade2",fade2);
        strcat(_toXml,_buffer);
        sprintf(_buffer,_formatf,"pregain1",pregain1);
        strcat(_toXml,_buffer);
