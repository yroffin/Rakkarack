...
StereoHarm::StereoHarm(long int Quality, int DS, int uq, int dq) : YroEffectPlugin("StereoHarm")
{
...
void
StereoHarm::render(jack_nframes_t nframes,float *smpsl, float *smpsr)
{
