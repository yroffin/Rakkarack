...
Vocoder::Vocoder(float *auxresampled_,int bands, int DS, int uq, int dq) : YroEffectPlugin("Vocoder")
{
 ...
 */
void
Vocoder::render(jack_nframes_t nframes,float * smpsl, float * smpsr)
{
  int i, j;
